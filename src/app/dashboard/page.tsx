    ...
    return (
        ...
        <div className="p-8 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <Link href="/dashboard/document-qa" className="block group">
                    <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 group-hover:shadow-lg transition-all transform group-hover:-translate-y-1">
                        ...
                        <p className="text-2xl font-bold text-gray-900">Document QA</p>
                        <p className="text-sm text-gray-400 mt-1">Chat with your PDFs and text files</p>
                    </div>
                </Link>
            </div>
            ...
            {session.user.role === "admin" && (
                <div className="mt-8">
                    <Link href="/admin" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-slate-900 hover:bg-slate-800 transition-colors shadow-lg">
